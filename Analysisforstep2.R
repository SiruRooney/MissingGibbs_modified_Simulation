...
colnames(com.m)=c(" ","z1","z2","z3","z4","z5","z6","z7","z8","z9","z10","z11","z12","z13","z14","z15","x1","x2","x3","x4","x5","ÿ","r1","r2")
rownames(com.m)=c("Q_logit(y)","Q_logit(x4)","Q_logit(x5)","Q_logit(r1)","Q_logit(r2)","Q_logit(r3)")

colnames(obs.m)=c(" ","z1","z2","z3","z4","z5","z6","z7","z8","z9","z10","z11","z12","z13","z14","z15","x1","x2","x3","x4","x5","ÿ","r1","r2")
rownames(obs.m)=c("obs_logit(y)","obs_logit(x4)","obs_logit(x5)","obs_logit(r1)","obs_logit(r2)","obs_logit(r3)")

colnames(true.m)=c(" ","z1","z2","z3","z4","z5","z6","z7","z8","z9","z10","z11","z12","z13","z14","z15","x1","x2","x3","x4","x5","ÿ","r1","r2")
...
com1.list=lapply(com.list,function(x){x[-1][(x[-1]/16)<0.9]=rep(0,NROW(x[-1][(x[-1]/16)<0.9]));x[-1][(x[-1]/16)>=0.9]=rep(1,NROW(x[-1][(x[-1]/16)>=0.9]));x[1]=1;x})
