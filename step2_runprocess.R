#step2
setwd("F://Missingdatacodes_modified//MissingGibbs2")
rm(list=ls())

load("F://Missingdatacodes_modified//MissingGibbs2//step1_misgibsimdata2.RData")

source("F://Missingdatacodes_modified//MissingGibbs2//Gibbssampler4.R")
...
save.image("F://Missingdatacodes_modified//MissingGibbs2//step2_runcomp.RData")
proc.time()-ptm
